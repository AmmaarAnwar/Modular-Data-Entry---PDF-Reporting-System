...
function Tqareer25() {
    ...
    useEffect(() => {
        const fetchOfficers = async () => {
            try {
                const response = await axios.get("http://30.30.30.53:3000/reports/off_rel_off/");
    ...
    return (
        <div className="justify-center pt-20 text-center">
            <h2>عدد الصفح</h2>
            {/* Slider for navigating between pages */}
            <div className="mb-4">
                ...
                <table className="w-4/5 mx-auto border border-collapse border-black">
                    <thead>
                        <tr>
                            ...
                            <th className="px-4 py-2 border border-black">اسم </th>
                            <th className="px-4 py-2 border border-black">درجة </th>
