...
function Edkhal30() {
  ...
  let postObject = { "MIL_NO": null, "MIL_NO_FLAG": null, "SENIORITY_NAME": null, "STATUS": null, "NAME": null, "Rank": null, "SEC_EXAME_NO": null, "BERTH_DATE": null, "CIV_ID_CARD_NO": null, "NCO_DATE": null, "GOVERNORATE_NO": null, "MAJOR_SPEC_NO": null, "MINOR_SPEC_NO": null, "CLASS_NO": null, "CATEGORY_NO": null, "RANK_NO": null, "SENIORIT_LIST": null, "SENIORITY_SERIAL": null, "SENIORITY_NO": null, "SUPPLIER_NO": null, "CORP_NO": null, "E_BATCH_TYPE": null, "E_BATCH_NO": null, "BATCH_TYPE": null, "BATCH_NO": null, "MARITAL_STATUS": null, "RELIGION": null, "BLOOD_TYPE": null, "SPEC_STATUS": null, "GENDER": null, "warning": false, "msg": "" };
    ...
    <>
      ...
      <div className=" h-full">
        <div className="border-2 border-gray-400 my-[5px] rounded-xl">
            ...
            <div className="flex justify-center items-center">
                ...
                <button onClick={
                  async () => {
                    ...
                    if (!(document.getElementById("MIL_NO").value == "")) {
                      const response = await axios.get(`http://30.30.30.53:3000/edkhal/edkhal30?mil_no=${document.getElementById("MIL_NO").value}`);
              ...
              <div className=" mx-1 ">
                <button onClick={async () => {
                  ...
                  console.log(values.SENIORITY_NAME);
          ...
          <div>
            <div className="flex justify-start align-middle m-2">
              ...
              <input
                ...
                type="text"
                id="feaa"
                className="bg-gray-50 w-20  ml-1 border p-1 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  "
                required
              />
              <label htmlFor="feaa" className="mx-2 font-medium text-gray-900">
