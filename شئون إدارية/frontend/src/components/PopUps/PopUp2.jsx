...
function PopUp2(props) {
    ...
    useEffect(() => {
        if (props.Data.PROMOTION) {
            setInitialData([...props.Data.PROMOTION]);
            setMyData([...props.Data.PROMOTION]);
        }
        ...
        try {
            try {
                const response = await axios.post(
                    "http://30.30.30.53:3000/edkhal/edkhal1/popup2",
                    {
                            ...
                            <div className="max-h-96 overflow-y-auto">
                                <table className="w-full border-collapse text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    <thead className="text-xs text-gray-900 uppercase dark:text-gray-400">
                                        <tr>
                                            <th scope="col" className="px-6 py-3">تاريخ الترقى</th>
                                            ...
                                            >
                                                ...
                                                <td className="px-6 py-4 text-center">
                                                    {editIndex === index ? (
                                                        ...
                                                        >
                                                            <option value=" "></option>
                                                            <option value="N">ترقى بنشرة</option>
                                                            <option value="E">ترقى إستثنائية</option>
                                                        </select>
                                                    ) : (
                                                        e.TYPE === "N"
                                                            ? "ترقى بنشرة"
